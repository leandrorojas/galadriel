...
class SideBar():
    ...
    def __sidebar_items(self) -> rx.Component: 
        return rx.vstack(
            ...
            self.__sidebar_item("Suites", "layout-dashboard", navigation.routes.HOME),
            self.__sidebar_item("Blog", "newspaper", navigation.routes.HOME),
            self.__sidebar_item("Create Post", "sticky-note", navigation.routes.HOME),
            self.__sidebar_item("Contact", "mail", navigation.routes.HOME),
            self.__sidebar_item("Contact History", "history", navigation.routes.HOME),
            spacing="1",
            width="100%",
        )
